...
function tryMerge(x, y) {
  ...
  // žiadna rekurzia – jednoduchý, čitateľný merge (zen)
}

/* Hľadá spojitú skupinu rovnakých elementov (4-susedia) */
...
function findGroup(x, y, element) {
  ...
  while (stack.length) {
    ...
    if (!tile || tile.isCore || tile.element !== element) continue;
